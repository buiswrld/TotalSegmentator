...
COL_SUFFICIENT_DATA_FLAG = "Sufficient Data for AUC (has_sufficient_data)"
COL_AUC_MIN = "Minimum AUC Across Thresholds (auc_min)"
COL_AUC_MAX = "Maximum AUC Across Thresholds (auc_max)"
COL_AUC_RANGE = "AUC Range Across Thresholds (auc_range)"
COL_ACCEPT_RATE_MIN = "Minimum Accept Rate Across Thresholds (accept_rate_min)"
COL_ACCEPT_RATE_MAX = "Maximum Accept Rate Across Thresholds (accept_rate_max)"
COL_ACCEPT_RATE_RANGE = "Accept Rate Range Across Thresholds (accept_rate_range)"
COL_N_THRESHOLDS_EVALUATED = "Number of Thresholds with Sufficient Data (n_thresholds_evaluated)"
